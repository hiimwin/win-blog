...
export class AdminApiTokenApiClient {
     ...
     * @return OK
     */
    refresh(body?: TokenRequest | undefined): Observable<AuthenticatedResult_816699d3_2> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<AuthenticatedResult_816699d3_2>;
                }
            } else
                return _observableThrow(response_) as any as Observable<AuthenticatedResult_816699d3_2>;
        }));
    }

    protected processRefresh(response: HttpResponseBase): Observable<AuthenticatedResult_816699d3_2> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AuthenticatedResult_816699d3_2.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class AuthenticatedResult_816699d3_2 implements IAuthenticatedResult_816699d3_2 {
    token!: string | undefined;
    refreshToken!: string | undefined;

    constructor(data?: IAuthenticatedResult_816699d3_2) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): AuthenticatedResult_816699d3_2 {
        data = typeof data === 'object' ? data : {};
        let result = new AuthenticatedResult_816699d3_2();
        result.init(data);
        return result;
    }
...
export interface IAuthenticatedResult_816699d3_2 {
    token: string | undefined;
    refreshToken: string | undefined;
}
